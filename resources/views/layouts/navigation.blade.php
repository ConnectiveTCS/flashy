<aside id="sidebar-multi-level-sidebar"
    class="top-0 left-0 z-40 w-64 transition-transform -translate-x-full sm:translate-x-0 mt-12" aria-label="Sidebar">
    <div class=" h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <div id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content"
                ...
                role="tablist">
                <li class="border-b border-t border-gray-200 dark:border-gray-700 mb-4">
                    <a href="#"
                ...
                <li role="presentation">
                    <button
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Flashcards</span>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Generate
                                Cards</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Practice Papers</span>
                    </button>
                </li>
                <li>
                    <a href="#"
